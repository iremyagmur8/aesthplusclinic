        ...
        <div class="portlet-header flex-row flex d-flex align-items-center">
            ...
            <div class="col-md-12">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <label for="title">SSS Kategorisi</label>
                            <select class="form-control" name="category2" id="ustKategori">
                                <option value="0"
                                        @if(!empty($cData->data) && $cData->data->category2_id == 0) selected @endif>
                                    Lütfen Seçin
                                </option>
                                ...
                                @isset($cData->categories )
                                    @foreach($cData->categories as $category)
                                        <option value="{{$category->id}}"
                                                @if(!empty($cData->data) && $cData->data->category2_id == $category->id) selected @endif>{{$category->title}}</option>

                                        @if(count($category->childs))
                                            @php $padding = " "; @endphp

                                            @if(!empty($cData)) @include('solaris.categories.subCategories2',['childs' => $category->childs,'padding'=> $padding,'cData'=>$cData,'cate'=>2])
                                            @else @include('solaris.categories.subCategorie2s',['childs' => $category->childs,'padding'=> $padding,'cate'=>2])
                                            @endif
